...
void plotHtoTaus(){
  ...
  TString baseline_plus = "nJets30 >=2 && HiggsSVFit_Pt > 100 && HiggsSVFit_dijetMass > 300";
  ...
  TString region = "Tau_training_011921";
  ...
  map<TString, BinInfo> varDict {
	...
	{"DZeta",	BinInfo("HiggsSVFit_DZeta",  "D_{#zeta}", 24, -40, 200)},
  };

  std::function<void(TCanvas*)> plotextra;
  for (auto &var : varDict){
    z.resetSelection();
    z.setSelection(baseline_plus + baseline_emuChan, "baseline_2018", "");
