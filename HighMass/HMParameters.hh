...
const TString baseForNorm = "met>100 && njets>=5 && nlbjets>=2 && nbjets>=1";
...
BaseConfig qcdConfig(){
  ...
  config.addSample("qcd-cr-withveto",  "QCD",      "qcd-std/qcd",          qcdvetowgt,  datasel + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-sr-withveto",  "QCD",      "qcd-std/qcd",          qcdvetowgt,  datasel + trigSR + vetoes + dphi);
