...
BaseConfig qcdConfig(){
  ...
  config.addSample("qcd-norm",       "QCD",           "sr/qcd-sr",       lepselwgt,   datasel + trigSR + revert_vetoes + qcdSpikeRemovals);
  ...
  if (SPLITTF){
    config.addSample("qcd-sr-int",     "QCD",           "sr/qcd-sr",       qcdwgt,      datasel + trigSR + qcdSpikeRemovals);
  }
