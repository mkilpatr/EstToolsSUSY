...
std::map<TString, TString> lepcrMapping = phocrMapping;
std::map<TString, TString> lepcrCuts = phocrCuts;
std::map<TString, TString> lepcrlabels = phocrlabels;
std::map<TString, std::vector<int>> lepcrMETbins = phocrMETbins;
