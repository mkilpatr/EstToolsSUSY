...
const TString trigDiLepCR = " && passtrigdilep";
const TString datasel = " && passjson && passmetfilters && j1chEnFrac>0.1";
...
BaseConfig zllConfig(){
  ...
  config.addSample("doublelep", "Data",                   "zllcr/doublelep",                "1.0",     datasel + trigDiLepCR);
...
BaseConfig qcdConfig(){
  ...
  config.addSample("qcd-cr-withveto",  "QCD",      "qcd-4bd/qcd",          qcdvetowgt,  datasel + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-sr-withveto",  "QCD",      "qcd-4bd/qcd",          qcdvetowgt,  datasel + trigSR + vetoes + dphi);
...
BaseConfig sigConfig(){
  ...
  config.addSample("data-sr",        "Data",             "sr/met",                    "1.0",  datasel + trigSR + vetoes);
