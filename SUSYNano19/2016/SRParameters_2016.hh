...
const TString wgtvar = lumistr_2016+"*1000*Stop0l_evtWeight*Stop0l_trigger_eff_MET_loose_baseline*puWeight*BTagWeight*PrefireWeight*WtagSF*TopSF*SoftBSF*Stop0l_ResTopWeight"; //2016
...
BaseConfig lepConfig(){
  ...
  if (ADD_LEP_TO_MET){
    config.addSample("singlelep",        "Data",          datadir+"met_2016", 		   "1.0",       datasel + trigLepCR + lepcrsel);
