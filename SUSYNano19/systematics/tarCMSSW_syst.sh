...
tar --exclude-caches-all -zcf ${CMSSW}.tgz $CMSSW --exclude="$CMSSW/src/AnalysisMethods/macros/*" --exclude="$CMSSW/src/AnalysisBase/*" --exclude="$CMSSW/src/.git/*" --exclude="*.root" --exclude="*.pdf" --exclude="*.png" --exclude="*.log" --exclude="*.err" --exclude="*.out" --exclude="*.txt" --exclude="*.tex" --exclude="*.sh" --exclude="AnalysisTools/*" --exclude="PhysicsTools/*.root" --exclude="AnalysisMethods/EstTools/datacard_moriond17/*"
