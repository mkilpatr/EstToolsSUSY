...
//    config.addSample("qcd",         "QCD",           "lepcr/qcd",             onelepcrwgt, datasel() + trigLepCR + lepcrsel);
  ...
  if(doLepSyst){
    ...
    config.addSample("ttbar-2017-eventsf-sr",    "t#bar{t}",      inputdir_2017+"ttbar",            seplepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-2017-eventsf-sr",    "W+jets",        inputdir_2017+"wjets",            seplepvetowgt_2017(), datasel() + revert_vetoes_sep());
    ...
    config.addSample("ttbar-2018-eventsf-sr",    "t#bar{t}",      inputdir_2018+"ttbar",             seplepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-2018-eventsf-sr",    "W+jets",        inputdir_2018+"wjets",             seplepvetowgt_2018(), datasel() + revert_vetoes_sep());
    ...
    config.addSample("ttbar-2017-event-sr",    "t#bar{t}",      inputdir_2017+"ttbar",            nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-2017-event-sr",    "W+jets",        inputdir_2017+"wjets",            nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("tW-2017-event-sr",       "tW",            inputdir_2017+"tW",               nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-2017-event-sr",      "ttW",           inputdir_2017+"ttW",              nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("ttZ-2017-event-sr",      "ttZ",           inputdir_2017+"ttZ",              nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("diboson-2017-event-sr",  "Diboson",       inputdir_2017+"diboson",          nolepvetowgt_2017(), datasel() + revert_vetoes_sep());

    config.addSample("ttbar-2018-event-sr",    "t#bar{t}",      inputdir_2018+"ttbar",             nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-2018-event-sr",    "W+jets",        inputdir_2018+"wjets",             nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("tW-2018-event-sr",       "tW",            inputdir_2018+"tW",                nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-2018-event-sr",      "ttW",           inputdir_2018+"ttW",               nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("ttZ-2018-event-sr",      "ttZ",           inputdir_2018+"ttZ",               nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("diboson-2018-event-sr",  "Diboson",       inputdir_2018+"diboson",           nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
  }
...
//    config.addSample("qcd",         "QCD",           "lepcr/qcd",             onelepcrwgt, datasel() + trigLepCR + lepcrsel);
    ...
    config.addSample("ttbar",         "t#bar{t}",      inputdir_2017+"ttbar",           lepselwgt_2017(),      datasel() + revert_vetoes());
    config.addSample("wjets",         "W+jets",        inputdir_2017+"wjets",           lepselwgt_2017(),      datasel() + revert_vetoes());
  ...
  // samples for sr categories
  config.addSample("ttbar-sr",    "t#bar{t}",      inputdir_2017+"ttbar",            lepvetowgt_2017(), datasel() + vetoes());
  config.addSample("wjets-sr",    "W+jets",        inputdir_2017+"wjets",            lepvetowgt_2017(), datasel() + vetoes());
  ...
  if(doLepSyst){
    //yields for MC with specific lepton SF choosing smallest pt
    config.addSample("ttbar-eventsf-sr",    "t#bar{t}",      inputdir_2017+"ttbar",            seplepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-eventsf-sr",    "W+jets",        inputdir_2017+"wjets",            seplepvetowgt_2017(), datasel() + revert_vetoes_sep());
    ...
    //yields for MC without specific lepton SF
    config.addSample("ttbar-event-sr",    "t#bar{t}",      inputdir_2017+"ttbar",            nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-event-sr",    "W+jets",        inputdir_2017+"wjets",            nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("tW-event-sr",       "tW",            inputdir_2017+"tW",               nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-event-sr",      "ttW",           inputdir_2017+"ttW",              nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("ttZ-event-sr",      "ttZ",           inputdir_2017+"ttZ",              nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("diboson-event-sr",  "Diboson",       inputdir_2017+"diboson",          nolepvetowgt_2017(), datasel() + revert_vetoes_sep());
  }
...
//    config.addSample("qcd",         "QCD",           "lepcr/qcd",             onelepcrwgt, datasel() + trigLepCR + lepcrsel);
    ...
    config.addSample("ttbar",         "t#bar{t}",      inputdir_2018+"ttbar",           lepselwgt_2018(),      datasel() + revert_vetoes());
    config.addSample("wjets",         "W+jets",        inputdir_2018+"wjets",           lepselwgt_2018(),      datasel() + revert_vetoes());
  ...
  // samples for sr categories
  config.addSample("ttbar-sr",    "t#bar{t}",      inputdir_2018+"ttbar",             lepvetowgt_2018(), datasel() + vetoes());
  config.addSample("wjets-sr",    "W+jets",        inputdir_2018+"wjets",             lepvetowgt_2018(), datasel() + vetoes());
  ...
  if(doLepSyst){
    //yields for MC with specific lepton SF choosing smallest pt
    config.addSample("ttbar-eventsf-sr",    "t#bar{t}",      inputdir_2018+"ttbar",             seplepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-eventsf-sr",    "W+jets",        inputdir_2018+"wjets",             seplepvetowgt_2018(), datasel() + revert_vetoes_sep());
    ...
    //yields for MC without specific lepton SF
    config.addSample("ttbar-event-sr",    "t#bar{t}",      inputdir_2018+"ttbar",             nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-event-sr",    "W+jets",        inputdir_2018+"wjets",             nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("tW-event-sr",       "tW",            inputdir_2018+"tW",                nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-event-sr",      "ttW",           inputdir_2018+"ttW",               nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("ttZ-event-sr",      "ttZ",           inputdir_2018+"ttZ",               nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("diboson-event-sr",  "Diboson",       inputdir_2018+"diboson",           nolepvetowgt_2018(), datasel() + revert_vetoes_sep());
  }
...
BaseConfig qcdConfig(){
  ...
  if(doLepSyst){
    ...
    config.addSample("qcd-2017-event-withveto-cr",  "QCD",  inputdir_2017+"qcd",         qcdvetowgt_2017(),  datasel() + revert_vetoes_sep() + dphi_invert());
    config.addSample("qcd-2017-event-withveto-sr",  "QCD",  inputdir_2017+"qcd",         qcdvetowgt_2017(),  datasel() + revert_vetoes_sep());
    config.addSample("qcd-2018-event-withveto-cr",  "QCD",   inputdir_2018+"qcd",         qcdvetowgt_2018(),  datasel() + revert_vetoes_sep() + dphi_invert());
    config.addSample("qcd-2018-event-withveto-sr",  "QCD",   inputdir_2018+"qcd",         qcdvetowgt_2018(),  datasel() + revert_vetoes_sep());
    ...
    config.addSample("ttbar-2017-event-cr",    "t#bar{t}",      inputdir_2017+"ttbar",            lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-2017-event-cr",    "W+jets",        inputdir_2017+"wjets",            lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("tW-2017-event-cr",       "tW",            inputdir_2017+"tW",               lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-2017-event-cr",      "ttW",           inputdir_2017+"ttW",              lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("znunu-2017-event-cr",  "znunu",       inputdir_2017+"znunu",          lepvetowgt_2017(), datasel() + revert_vetoes_sep());

    config.addSample("ttbar-2018-event-cr",    "t#bar{t}",      inputdir_2018+"ttbar",             lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-2018-event-cr",    "W+jets",        inputdir_2018+"wjets",             lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("tW-2018-event-cr",       "tW",            inputdir_2018+"tW",                lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-2018-event-cr",      "ttW",           inputdir_2018+"ttW",               lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("znunu-2018-event-cr",  "znunu",       inputdir_2018+"znunu",           lepvetowgt_2018(), datasel() + revert_vetoes_sep());
  }
...
BaseConfig qcdConfig2017(){
  ...
  if(doLepSyst){
    ...
    //yields for MC without specific lepton SF
    config.addSample("qcd-event-withveto-cr",  "QCD",  inputdir_2017+"qcd",         qcdvetowgt_2017(),  datasel() + revert_vetoes_sep() + dphi_invert());
    config.addSample("qcd-event-withveto-sr",  "QCD",  inputdir_2017+"qcd",         qcdvetowgt_2017(),  datasel() + revert_vetoes_sep());
    
    config.addSample("ttbar-event-cr",    "t#bar{t}",      inputdir_2017+"ttbar",            lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-event-cr",    "W+jets",        inputdir_2017+"wjets",            lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("tW-event-cr",       "tW",            inputdir_2017+"tW",               lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-event-cr",      "ttW",           inputdir_2017+"ttW",              lepvetowgt_2017(), datasel() + revert_vetoes_sep());
    config.addSample("znunu-event-cr",  "znunu",       inputdir_2017+"znunu",          lepvetowgt_2017(), datasel() + revert_vetoes_sep());
  }
...
BaseConfig qcdConfig2018(){
  ...
  if(doLepSyst){
    ...
    //yields for MC without specific lepton SF
    config.addSample("qcd-event-withveto-cr",  "QCD",   inputdir_2018+"qcd",         qcdvetowgt_2018(),  datasel() + revert_vetoes_sep() + dphi_invert());
    config.addSample("qcd-event-withveto-sr",  "QCD",   inputdir_2018+"qcd",         qcdvetowgt_2018(),  datasel() + revert_vetoes_sep());
    
    config.addSample("ttbar-event-cr",    "t#bar{t}",      inputdir_2018+"ttbar",             lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("wjets-event-cr",    "W+jets",        inputdir_2018+"wjets",             lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("tW-event-cr",       "tW",            inputdir_2018+"tW",                lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("ttW-event-cr",      "ttW",           inputdir_2018+"ttW",               lepvetowgt_2018(), datasel() + revert_vetoes_sep());
    config.addSample("znunu-event-cr",  "znunu",       inputdir_2018+"znunu",           lepvetowgt_2018(), datasel() + revert_vetoes_sep());
  }
