...
void BkgPred_LowMET_LL(){
  ...
  plot(altpred_low, altgraphs_low, "std_pred_trad_LM_2018_noextrap_toppt_mgpow", "Low");
  plot(altpred_high, altgraphs_high, "std_pred_trad_HM_2018_noextrap_toppt_mgpow", "High");
