...
BaseConfig sigConfig(){
  ...
  config.addSample("data-2017-sr",   "Data",      inputdir_2017+"met",                    "1.0",  datasel + trigSR + vetoes);
  config.addSample("data-2018-sr",   "Data",      inputdir_2018+"met",                    "1.0",  datasel + trigSR + vetoes);
