...
void BkgPred_LowMET_LL(){
  ...
  plot(altpred, altgraphs, mc, lepcr, "std_pred_trad_Run2_withttZRare");
  plot(altpred_low, altgraphs_low, mc_low, lepcr_low, "std_pred_trad_LM_Run2_withttZRare", "Low");
  plot(altpred_high, altgraphs_high, mc_high, lepcr_high, "std_pred_trad_HM_Run2_withttZRare", "High");
