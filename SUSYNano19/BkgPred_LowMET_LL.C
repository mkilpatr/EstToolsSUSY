...
void BkgPred_LowMET_LL(){
  ...
  plot(altpred_low, altgraphs_low, mc_low, lepcr_low, "std_pred_trad_LM_toppt_mgpow", "Low");
  plot(altpred_high, altgraphs_high, mc_high, lepcr_high, "std_pred_trad_HM_toppt_mgpow", "High");
