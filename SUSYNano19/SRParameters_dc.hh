...
#include "binDefinitions_dc_small.hh"
...
//    config.addSample("qcd",         "QCD",           "lepcr/qcd",             onelepcrwgt, datasel + trigLepCR + lepcrsel);
  ...
  if (SPLITTF){
    ...
    config.addSample("ttZ-2016-sr-int",         "ttZ",           inputdir_2016+"ttZ",                  lepvetowgt+"*"+ttznorm, datasel + vetoes  + invert_genLep);
    config.addSample("diboson-2016-sr-int",     "Rare",       inputdir_2016+"diboson",              lepvetowgt, datasel + vetoes + invert_genLep);
    ...
    config.addSample("ttZ-2017-sr-int",      "ttZ",           inputdir_2017+"ttZ",              lepvetowgt_2017+"*"+ttznorm, datasel + vetoes + invert_genLep);
    config.addSample("diboson-2017-sr-int",  "Rare",       inputdir_2017+"diboson",          lepvetowgt_2017, datasel + vetoes + invert_genLep);
    ...
    config.addSample("ttZ-2018-sr-int",      "ttZ",           inputdir_2018+"ttZ",               lepvetowgt_2018+"*"+ttznorm, datasel + vetoes + invert_genLep);
    config.addSample("diboson-2018-sr-int",  "Rare",       inputdir_2018+"diboson",           lepvetowgt_2018, datasel + vetoes + invert_genLep);
  }
...
BaseConfig srConfig(){
  ...
  //config.addSample("diboson",        "Rare",       inputdir_2016+"diboson",           lepvetowgt, datasel + vetoes);
