...
#include "LowMET_Parameters_2016and2017.hh"

#include "../../EstMethods/LLBEstimator.hh"

using namespace EstTools;

void BkgPred_LowMET_LL_2016and2017(){
  ...
  plot(altpred_low, altgraphs_low, "std_pred_trad_LM_2016and2017", "Low");
  plot(altpred_high, altgraphs_high, "std_pred_trad_HM_2016and2017", "High");
